...
class PostTemplate extends StatefulWidget {
  ...
  const PostTemplate(
      ...
      required this.url, required this.userID})
      : super(key: key);
  @override
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 5,),
                LikeButton(number: widget.likes, docid: widget.postid, userID: widget.userID,),
                CommentButton(number: widget.comments, docid: widget.postid,userID: widget.userID,),
                _regState ?  LocationButton(
                  location: nameAuthor(widget.userID).toString(),
                ) :  const SizedBox(width: 2.0,),
                _regState ?  boostButton(
                  docid: widget.postid,
                ...
                Row(
                  ...
                  children: [
                    InkWell(
                      ...
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => AdminProfile(userID: widget.userID)));
                      },
                    ),
                    Container(
                      height: 30,
